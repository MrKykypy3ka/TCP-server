...
def start():
    ...
    save_pivot_table_as_image(table2, 'data/results/date.png', custom_red, 'С учётом дней недель')
    save_pivot_table_as_image(table3, 'data/results/time.png', custom_red, 'С учётом времени', fontsize=6)

    save_tables_and_images_to_word(pivot_table_all_time, table1, pivot_table_date, table2, 'data/results/all_time.png', 'data/results/date.png', 'data/results/Отчёт.docx')
